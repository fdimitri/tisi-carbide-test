...
class TicketCategoriesControllerTest < ActionController::TestCase
  ...
  test "should create ticket_category" do
    assert_difference('TicketCategory.count') do
      post :create, ticket_category: { TicketGroup_id: @ticket_category.TicketGroup_id, User_id: @ticket_category.User_id, desc: @ticket_category.desc, name: @ticket_category.name }
    end
  ...
  test "should update ticket_category" do
    patch :update, id: @ticket_category, ticket_category: { TicketGroup_id: @ticket_category.TicketGroup_id, User_id: @ticket_category.User_id, desc: @ticket_category.desc, name: @ticket_category.name }
    assert_redirected_to ticket_category_path(assigns(:ticket_category))
  end
