class TicketGroupsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @ticket_group.save
        ...
        format.json { render :show, status: :created, location: @ticket_group }
      else
  ...
  def update
    respond_to do |format|
      if @ticket_group.update(ticket_group_params)
        ...
        format.json { render :show, status: :ok, location: @ticket_group }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to ticket_groups_url, notice: 'Ticket group was successfully destroyed.' }
  ...
  private
    ...
    def ticket_group_params
      params.require(:ticket_group).permit(:name, :desc, :User_id)
    end
end
